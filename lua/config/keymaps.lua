...
if vim.g.vscode then
	...
	map("n", harpoon_prefix .. "d", function()
		vsc.action("vscode-harpoon.editorQuickPick", { count = 1 })
	end, opts)
	map("n", harpoon_prefix .. "s", function()
		vsc.action("vscode-harpoon.editEditors", { count = 1 })
	end, opts)
	map("n", "<M-0>", function()
		vsc.action("vscode-harpoon.editEditors", { count = 1 })
	end, opts)
	map("n", "<M-1>", function()
		vsc.action("vscode-harpoon.gotoEditor1", { count = 1 })
	end, opts)
	map("n", "<M-2>", function()
		vsc.action("vscode-harpoon.gotoEditor2", { count = 1 })
	end, opts)
	map("n", "<M-3>", function()
		vsc.action("vscode-harpoon.gotoEditor3", { count = 1 })
	end, opts)
	map("n", "<M-4>", function()
		vsc.action("vscode-harpoon.gotoEditor4", { count = 1 })
	end, opts)
	map("n", "<M-5>", function()
		vsc.action("vscode-harpoon.gotoEditor5", { count = 1 })
	end, opts)
	map("n", "<M-6>", function()
		vsc.action("vscode-harpoon.gotoEditor6", { count = 1 })
	end, opts)
	map("n", "<M-7>", function()
		vsc.action("vscode-harpoon.gotoEditor7", { count = 1 })
	end, opts)
	map("n", "<M-8>", function()
		vsc.action("vscode-harpoon.gotoEditor8", { count = 1 })
	end, opts)
	map("n", "<M-9>", function()
		vsc.action("vscode-harpoon.gotoEditor9", { count = 1 })
	end, opts)
end
