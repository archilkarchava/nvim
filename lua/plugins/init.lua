...
return {
  ...
  },
  {
    ...
    opts = {
      ...
      buffer     = { suffix = not not vim.g.vscode and "" or "b", options = {} },
      comment    = { suffix = "c", options = {} },
      conflict   = { suffix = not not vim.g.vscode and "" or "x", options = {} },
      diagnostic = { suffix = not not vim.g.vscode and "" or "d", options = {} },
      file       = { suffix = not not vim.g.vscode and "" or "f", options = {} },
      indent     = { suffix = "i", options = {} },
      jump       = { suffix = "j", options = {} },
      location   = { suffix = "l", options = {} },
      oldfile    = { suffix = not not vim.g.vscode and "" or "o", options = {} },
      quickfix   = { suffix = not not vim.g.vscode and "" or "q", options = {} },
      treesitter = { suffix = "t", options = {} },
      undo       = { suffix = "", options = {} },
      window     = { suffix = not not vim.g.vscode and "" or "w", options = {} },
